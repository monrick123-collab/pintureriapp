    ...
    <div className="h-screen flex overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 h-full relative">
        ...
        <div className="flex-1 flex overflow-hidden bg-slate-50 dark:bg-slate-900">
          ...
          <div className="w-[380px] bg-white dark:bg-slate-800 border-l border-slate-200 dark:border-slate-700 flex flex-col z-20 shadow-xl">
            ...
            <div className="p-4 border-t dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 space-y-4">
              ...
              <button disabled={cart.length === 0} onClick={() => setIsPaymentModalOpen(true)} className="w-full py-3 bg-primary text-white font-bold rounded-xl shadow-lg active:scale-95 disabled:opacity-50 transition-all">
                Pagar Ahora
              </button>
            </div>
          </div>
            ...
            <div className="bg-white dark:bg-slate-800 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <button onClick={handleFinalizeSale} className="flex-1 py-3 bg-primary text-white font-bold rounded-xl">Finalizar</button>
                </div>
              </div>
              {showSuccess && (
